...
== Installation
    ...
    git clone git clone git@github.com:f0y/redmine_private_wiki.git -b redmine-2.0 plugins/redmine_private_wiki -b redmine-2.0 plugins/redmine_private_wiki
    rake redmine:plugins:migrate RAILS_ENV=production

In addition you can read instructions on http://www.redmine.org/projects/redmine/wiki/Plugins

== Compatibility

Compatible with Redmine 2.0 and higher
